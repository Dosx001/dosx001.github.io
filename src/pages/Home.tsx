  ...
  const posts = [
    {
      ...
      content: [
        {
          tag: "p",
          inner: "Welcome to my website, build using React and hosted by GitHub pages. This site is designed to introduce myself by showcasing my background and interests. So have a look around and get to know me."
        }
      ],
    },
    {
      ...
      content: [
        {
          tag: "p",
          inner: "Hello, my name is Andres Rodriguez Michel. I am a Cal Poly graduate with a bachelor in Physics. I currently looking for work in software related fields."
        }
      ]
    },
    {
